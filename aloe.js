const aloe = {
  ...
  "Aloe vera var. barbadensis": {
    ...
    howToGrow: "Grow in sunny, warm locations with well-drained soil; water sparingly; can grow indoors in pots.",
  ...
  "Aloe vera var. chinensis": {
    ...
    howToGrow: "Plant in full sun, warm climates, well-drained soil, drought-tolerant; ideal for containers.",
    commonProblems: "Root rot if overwatered; pests include aphids and mealybugs; leaves may shrivel in extreme cold."
  },
  "Aloe cameronii": {
    commonNames: [],
  ...
  "Aloe marlothii": {
    ...
    howToGrow: "Plant in full sun, rocky or sandy soil, tolerates frost and drought.",
    commonProblems: "Root rot if overwatered; leaves can be damaged by prolonged cold; pests include aphids."
  },
  "Aloe striata": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, avoid frost.",
  ...
  "Aloe polyphylla": {
    ...
    commonProblems: "Highly sensitive to overwatering; prone to root rot; slow growth makes recovery difficult if stressed."
  },
  "Aloe dichotoma": {
    ...
    howToGrow: "Full sun, dry, well-drained soil; drought-tolerant; protect young plants from frost.",
    commonProblems: "Root rot from overwatering; frost damage to young plants; slow growth."
  },
  "Aloe maculata": {
    ...
    howToGrow: "Full sun to partial shade, well-drained soil, drought-tolerant, tolerate poor soils.",
    commonProblems: "Overwatering may cause root rot; leaf spots; occasional pests include mealybugs."
  },
  "Aloe speciosa": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, occasional watering during dry periods.",
    commonProblems: "Root rot from waterlogged soil; leaf discoloration; pests include aphids."
  },
  "Aloe thraskii": {
    ...
    howToGrow: "Full sun, sandy soil, drought and salt tolerant, protect from excessive frost.",
    commonProblems: "Root rot if overwatered; leaves can burn in extreme sun; pests include scale."
  },
  "Aloe brevifolia": {
    commonNames: [],
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, suitable for containers.",
    commonProblems: "Root rot if overwatered; leaf scorch in excessive sun; pests include aphids."
  },
  "Aloe plicatilis": {
    ...
    howToGrow: "Full sun, rocky well-drained soil, drought-tolerant, protect young plants from frost.",
    commonProblems: "Root rot from overwatering; leaf damage in cold; pests include scale and aphids."
  },
  "Aloe aristata": {
    ...
    howToGrow: "Full sun to partial shade, well-drained soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot if overwatered; leaf browning in extreme sun; pests include mealybugs."
  },
  "Aloe capitata": {
    commonNames: [],
    ...
    howToGrow: "Partial sun, well-drained rocky soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot if overwatered; leaves may scorch in full hot sun; pests include scale."
  },
  "Aloe humilis": {
    ...
    howToGrow: "Full sun, well-drained rocky soil, drought-tolerant, suitable for containers.",
    commonProblems: "Root rot if overwatered; leaf scorching in extreme heat; pests include aphids and mealybugs."
  },
  "Aloe mitriformis": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot if overwatered; leaf damage in cold; pests include scale."
  },
  "Aloe saponaria": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot if overwatered; leaf scorching; pests include mealybugs."
  },
  "Aloe aculeata": {
    ...
    howToGrow: "Full sun, rocky well-drained soil, drought-tolerant, protect young plants from frost.",
    commonProblems: "Root rot if overwatered; leaf damage in frost; pests include scale insects."
  },
  "Aloe barberae": {
  ...
  "Aloe dichotoma var. ramosissima": {
    ...
    howToGrow: "Full sun, dry well-drained soil, drought-tolerant, protect young plants from frost.",
    commonProblems: "Root rot if overwatered; frost damage to seedlings; slow growth."
  },
  "Aloe reynoldsii": {
    commonNames: [],
    ...
    howToGrow: "Full sun, well-drained rocky soil, drought-tolerant, ideal for containers.",
    commonProblems: "Overwatering can cause root rot; leaf scorch in extreme sun; pests include mealybugs."
  },
  "Aloe globuligemma": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, tolerates poor soils.",
    commonProblems: "Root rot if overwatered; leaf discoloration; pests include aphids."
  },
  "Aloe somaliensis": {
    ...
    howToGrow: "Partial sun, well-drained rocky soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot from overwatering; leaves may scorch in direct sun; pests include scale."
  },
  "Aloe excelsa": {
    ...
    howToGrow: "Full sun, rocky well-drained soil, drought-tolerant, protect young plants from frost.",
    commonProblems: "Root rot if overwatered; frost damage to seedlings; pests include scale."
  },
  "Aloe kedongensis": {
    commonNames: [],
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, tolerates poor soils.",
    commonProblems: "Overwatering may cause root rot; leaf scorching in hot sun; pests include mealybugs."
  },
  "Aloe cameronii var. major": {
    ...
    howToGrow: "Full sun, well-drained rocky soil, drought-tolerant, protect from frost.",
    commonProblems: "Root rot if overwatered; leaf discoloration in shade; pests include scale."
  },
  "Aloe zebrina": {
    ...
    howToGrow: "Full sun, well-drained soil, drought-tolerant, suitable for containers.",
    commonProblems: "Overwatering can cause root rot; leaf damage in frost; pests include aphids."
  },
  "Aloe vera var. chinensis major": {
    ...
    howToGrow: "Full sun, warm, well-drained soil, drought-tolerant, ideal for containers.",
    commonProblems: "Root rot from overwatering; leaf damage in frost; pests include mealybugs and scale."
  }
};
